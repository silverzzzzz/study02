...
def main():
    ...
    while page_count>0:
        ...
        ##ページャー（次へ）をクリック
        ##=====
        pager_button = driver.find_element_by_css_selector('body > div.wrapper > div:nth-child(5) > form > div > nav:nth-child(103) > ul > li.pager__next > a')
        actions = ActionChains(driver)
        actions.move_to_element(pager_button)
        time.sleep(3)
        pager_button.click()
        page_count -= 1
